...
exports.default = {
    name: utils_1.default.EVENTS.User.Get,
    ...
    run: function (socket, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                socket.emit(utils_1.default.EVENTS.User.Get, user); // send a success message to the user
            }
            catch (error) {
                logger_1.default.error(error);
                socket.emit(utils_1.default.EVENTS.User.Get, { error: "An error occured" });
            }
        });
    }
};
